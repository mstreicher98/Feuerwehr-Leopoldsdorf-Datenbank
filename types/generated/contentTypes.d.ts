...
export interface ApiFahrzeugeFahrzeuge extends Schema.CollectionType {
  collectionName: 'fahrzeuges';
  info: {
    description: '';
    displayName: 'Fahrzeuge';
    pluralName: 'fahrzeuges';
    singularName: 'fahrzeuge';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    Bilder: Attribute.Media<'images', true>;
    createdAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::fahrzeuge.fahrzeuge',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
    Fahrzeug_id: Attribute.String;
    Fahrzeugdaten: Attribute.JSON;
    Funkname: Attribute.String;
    Kurzbezeichnung: Attribute.String;
